...
const RecommendWidget = () => {
  ...
  const fetchResults = async () => {
    ...
    setError(null);
    try {
      const res = await fetch('http://localhost:5000/api/advanced/recommend', {
        method: 'POST',
                  ...
                  return (
                    ...
                    >
                      <div className="rec-card-img">
                        <img 
                          src={pg.photos?.[0] ? `http://localhost:5000${pg.photos[0]}` : 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&w=400'} 
                          alt={pg.name} 
                        />
